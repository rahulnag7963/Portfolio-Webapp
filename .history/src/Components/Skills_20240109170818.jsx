...
const Skills = () => {
  ...
  return (
    ...
    exit={{opacity:0}}
    >
      <Button>sdndjsakldjsakldshdakjhdkjashdkjassjdajldsajdjsdakldjlksajdlksajdlkasjdlkasjdlkasjdlksajdlkjsaldkjasjdlkasjdklsaldjsakldj</Button>
      <Button></Button>
      <Button></Button>
      <Button></Button>
      <FancyCarousel
      className="fancyPosition"
      images={images}
      carouselRadius={200}
