          ...
          <div className="row p-2 mx-auto">
            ...
            <motion.div 
              ...
              > 
                ...
                <Button href="https://github.com/rahulnag7963/cpc" className=""variant="info"> Code</Button>
                <Button href="https://github.com/rahulnag7963/cpc" className=""variant="info"> Website</Button>
              </motion.div>
            </div>
          </div>  
          <div className="row p-2 mx-auto">
