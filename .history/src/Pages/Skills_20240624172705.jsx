      ...
      >
        <div className="display-4 text-center pb-5">Skills</div>
          <Container>
            ...
            <Row className="p-2">
              <Col className="d-grid gap-2">
                <Button size="lg" variant="secondary" className="p-3 m-2" onClick={()=>setShow1(true)}>
              ...
              <Alert show={show1} variant="secondary">
                ...
                <div className="d-flex justify-content-end">
                  <Button onClick={() => setShow1(false)} variant="outline-secondary">
                    Close
                  </Button>
                </div>
              </Alert>
            ...
            <Row className="p-2">
              ...
              <Alert show2={show2} variant="success">
                <p>
                  {description[2]}
                </p>
                <div className="d-flex justify-content-end">
