...
import { Alert, Container, Row, Col , ProgressBar, Button } from "react-bootstrap";
      ...
      >
        ...
        <Row className="p-2">
          <Col className="d-grid gap-2">
            <Button size="lg"className="p-3 m-2" onClick={()=>setShow(true)}>More Info</Button>
          </Col>
          <Col xs={8}>
        ...
        <Row className="p-2">
          <Col className="d-grid gap-2">
            <Button size="lg" variant="secondary"className="p-3 m-2" onClick={()=>setShow(true)}>More Info</Button>
          </Col>
          <Col xs={8}>
        ...
        <Row className="p-2">
          <Col className="d-grid gap-2">
            <Button size="lg" variant="success"className="p-3 m-2" onClick={()=>setShow(true)}>More Info</Button>
          </Col>
          <Col xs={8}>
        ...
        <Row className="p-2">
          <Col className="d-grid gap-2">
            <Button size="lg" variant="info"className="p-3 m-2" onClick={()=>setShow(true)}>More Info</Button>
          </Col>
          <Col xs={8}>
        ...
        <Row className="p-2">
          <Col className="d-grid gap-2">
            <Button size="lg" variant="warning"className="p-3 m-2" onClick={()=>setShow(true)}>More Info</Button>
          </Col>
          <Col xs={8}>
