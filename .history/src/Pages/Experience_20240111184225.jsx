...
const Experience = () => {
  ...
  const handleClose = () => setShowGlobalRelay(false);
  const handleShow = () => setShowGlobalRelay(true);
  return (
  <div className="text-center">
    ...
    <Offcanvas show={showGlobalRelay} onHide={handleClose} placement="start">
    ...
    <Offcanvas show={showGlobalRelay} onHide={handleClose} placement="end">
        <Offcanvas.Header closeButton>
          <Offcanvas.Title>Offcanvas</Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body>
