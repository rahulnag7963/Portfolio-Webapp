    ...
    <Container fluid>
      ...
      <Offcanvas className="bg-danger" show={showGlobalRelay} onHide={handleCloseGlobalRelay} placement="start">
          ...
          <Offcanvas.Body>
            ...
            where I worked on both the front end backends 
            of the login section for the website. 
            ...
            <p>
              - Learned to communicate effectively to understand
      ...
      <Offcanvas className="bg-info" show={showOceanNetworks} onHide={handleCloseOceanNetworks} placement="end">
          ...
          <Offcanvas.Body>
            ...
            and help wherever necessary.
            <p>Skills developed:</p>
            <p>Hard skills:</p>
            <p>
              - Developed react typescript skills
              in testing components and end-to-end
              tests in frameworks such as Cypress,
              Jenkins, and Selenium to industry
              standards.
            </p>
            <p>
              - Updated several typescript components
              to add features and update dependencies
              based on client feedback.
            </p>
            <p>Soft skills:</p>
            <p>
              - Learned to work in a specific pod dealing
              specific parts of the software, that being
              the frontend.
            </p>  
            <p>
              - Learned to communicate and manage different
              tasks provided to me by my senior developer.
            </p>  
          </Offcanvas.Body>
      </Offcanvas>
    </Container>
